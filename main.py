...
def main():
    ...
    def escalera(cantidad_escalones, palo1_init, palo1_end, palo2_init, palo2_end, color=azul): # Dados dos palos y una cantidad de escalones dibuja los palos conectores
...
############################## PASO 2 #############################
    ...
    # Registrar comentarios para cada paso
    ...
    # Rotación por paso en el manual (Z es el eje vertical)
    engine.registrar_rotacion_paso(2, 180, eje="z")
    # Paso 3 mantiene esta misma rotación automáticamente, salvo que se redefina

    print(engine.generar_resumen_montaje_texto())

    engine.exportar_proyecto_json("proyecto_scout.json")
    engine.exportar_manual_pdf("manual_scout.pdf", titulo="Manual Scout - Puente Demo")
